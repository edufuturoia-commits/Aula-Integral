  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md mx-4">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Cancelar Citación</h2>
        <p className="text-gray-600 mb-6">Por favor, especifica el motivo de la cancelación. Esta información será visible para la otra parte.</p>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-4 mt-6">
            <button type="button" onClick={onClose} className="px-6 py-2 rounded-md text-gray-700 bg-gray-200 hover:bg-gray-300 transition-colors">Cerrar</button>
